...
$Location="D:\SCDPM\SQL\Alaska\08"
$ProtectiongroupName="SQL 2008 Alaska"

$Basedir = "\\$RecoveryLocationServer\SCDPM\SQL\Alaska\08"
$Date = Get-Date
...
Write-Host "Starte Datenbank wiederherstellung nach $Basedir ..." -ForegroundColor DarkYellow -BackgroundColor DarkGray
foreach ($entry in $ds) {
